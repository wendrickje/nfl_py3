...
Local model artifacts are not built in this clone (`artifacts/` is gitignored and starts empty). Run the reproduction commands under Quick start, then `nfl-ats publish-predictions`, to populate `artifacts/active_ats_model.json` and regenerate this section.
